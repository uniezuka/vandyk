    ...
    <div class="row border border-dark">
        ...
        <div class="col-6 border-top border-end  border-dark">
            <table class="table table-borderless m-0">
                <tr>
                    <td class="p-0">Deductible Savings</td>
                    <td class="p-0 text-end"><?= ($calculations->deductibleCredit == 0) ? "N/A" : "Included" ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="p-0">Loss Surcharge</td>
                    <td class="p-0 text-end"><?= ($calculations->lossDebit == 0) ? "N/A" : "Included" ?></td>
                </tr>
                <tr>
                    <td class="p-0">Mid Level Entry Surcharge</td>
                    <td class="p-0 text-end"><?= ($calculations->midLevelSurcharge == 0) ? "N/A" : "Included" ?></td>
                </tr>
                <tr>
                    <td class="p-0">Underinsured Surcharge</td>
                    <td class="p-0 text-end"><?= ($calculations->replacementCostSurcharge == 0) ? "N/A" : "Included" ?></td>
                </tr>
                <tr>
