...
$basement_finished = (int)getMetaValue($floodQuoteMetas, "basement_finished", 0);
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-6">
            <div class="logo mb-1">
                <img src="<?= base_url('assets/images/sandbarLogo100x270.png'); ?>" alt="logo" width="352" height="100">
            </div>
    ...
    <div class="row border-top border-dark">
        ...
        <div class="col-3">Finished Basement/Enclosure</div>
        <div class="col-3"><?= ($improvementDate == "") ? "&nbsp" : $improvementDate ?></div>
        <div class="col-3">&nbsp;</div>
        <div class="col-3">&nbsp;</div>
        <div class="col-3">Elevation Difference</div>
        <div class="col-3"></div>
    </div>
        ...
        <div class="col-12">
            <div class="row justify-content-start">
                <div class="col-3">
                    ...
                    <?php endif; ?>
                    <div class="small">
                        Basement coverage: <?= ($basement_finished == 1) ? "Yes" : "No" ?><br />
                        Basement personal property coverage: <?= ($basement_finished == 1) ? (($covCContent > 0) ? $formatter->formatCurrency(15000, 'USD') : "No") : "No" ?>
                    </div>
                </div>
                <div class="col-3">
...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p>
                <?php if ($entityType == 1) { ?>
                    18661 Hiscox Commercial Building and Personal Property FloodPlus Form<br />
                    18663 Hiscox Commercial Business Income (Extra Expense) property FloodPlus Form<br />
                    Hiscox FloodPlus Minimum Earned Premium Endorsement<br />
                    19815 LM Private Flood Insurance Advisory Notice<br />
                    LMA5020 Service of Suit Clause<br />
                <?php } ?>

                <?php if ($entityType == 0) { ?>
                    1719 Hiscox Homeowners FloodPlus Form<br />
                    Hiscox FloodPlus Minimum Earned Premium Endorsement<br />
                    19815 LM Private Flood Insurance Advisory Notice<br />
                    ...
                    <?php if ($hasOpprc) {
                        echo 'Hiscox FloodPlus Personal Property Replacement Cost Loss Settlement Endorsement<br />';
                    } ?>

                <?php } ?>

                <?php if ($propertyState == "NJ") { ?>
                    LMA9063 New Jersey Surplus Lines Notice<br />
                    LMA9064 New Jersey Surplus Lines Disclosure Notice<br />
                <?php } ?>
        </div>
    </div>
