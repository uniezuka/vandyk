...
<div class="row mb-3">
    <label class="d-flex justify-content-end col-sm-5 col-form-label">Set Hiscox Premium:</label>
    <div class="col-sm-4">
        <input type="text" class="form-control" placeholder="" name="hiscoxPremiumOverride" value="<?= set_value('hiscoxPremiumOverride', getMetaValue($floodQuoteMetas, "hiscoxPremiumOverride", 0)) ?>" />
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" placeholder="" name="fullPremiumOverride" value="<?= set_value('fullPremiumOverride', getMetaValue($floodQuoteMetas, "fullPremiumOverride", 0)) ?>" />
    </div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-5">
        <input type="text" class="form-control" placeholder="" name="hiscoxID" value="<?= set_value('hiscoxID', getMetaValue($floodQuoteMetas, "hiscoxID")) ?>" />
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-sm-12 d-flex justify-content-center">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" name="isBounded" <?= set_checkbox('isBounded', '1', getMetaValue($floodQuoteMetas, "isBounded", "0") == "1"); ?>>
            <label class="form-check-label">Bound</label>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-sm-12 d-flex justify-content-center">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" name="inForce" <?= set_checkbox('inForce', '1', getMetaValue($floodQuoteMetas, "inForce", "0") == "1"); ?>>
...
<div class="row mb-3">
    <div class="col-sm-12 d-flex justify-content-center">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" name="isForRenewal" <?= set_checkbox('isForRenewal', '1', getMetaValue($floodQuoteMetas, "isForRenewal", "0") == "1"); ?>>
            <label class="form-check-label"><strong>Flag for Non-Renewal</strong></label>
        </div>
    </div>
</div>