...
<div class="row mb-3">
    <label class="d-flex justify-content-end col-sm-4 col-form-label">Main Policy ID:</label>
    <div class="col-sm-8">
        <input type="text" class="form-control" value="<?= $floodQuote->flood_quote_id ?>" readonly />
    </div>
</div>
