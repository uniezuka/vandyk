...
<div class="row mb-3">
    ...
    <div class="d-flex align-items-end col-sm-8">
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="1" name="hasLossOccured" <?= set_radio('hasLossOccured', '1', getMetaValue($floodQuoteMetas, "hasLossOccured", "0") == "1"); ?> />
            <label class="form-check-label">Yes</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" value="0" name="hasLossOccured" <?= set_radio('hasLossOccured', '0', getMetaValue($floodQuoteMetas, "hasLossOccured", "0") == "0"); ?> />
