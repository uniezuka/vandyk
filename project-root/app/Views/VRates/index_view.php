    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="clearfix">
                    <a type="button" class="btn btn-primary float-end" href="<?= base_url('/v_rate/create'); ?>">Create Rate</a>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($rates as $rate): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('/v_rate/update/' . $rate->flood_v_rate_id); ?>">Update</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
