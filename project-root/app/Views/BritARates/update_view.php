...
<div class="col-md-5 col-sm-12">
    <div class="form">
        <form method="post">
            ...
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label text-end">Zip: </label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="zip" value="<?= set_value('zip', $rate->zip) ?>">
                </div>

                <label class="col-sm-2 col-form-label text-end">State: </label>
                <div class="col-sm-2">
                    <?= stateSelect('state', $rate->state_code) ?>
                </div>

                <label class="col-sm-2 col-form-label text-end">County: </label>
                <div class="col-sm-2">
                    <?= countySelect('county', $rate->county_id) ?>
                </div>
            </div>
