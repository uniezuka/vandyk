...
<div class="col-md-5 col-sm-12">
    <div class="form">
        <form method="post">
            ...
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label text-end">BCX Rate: </label>
                <div class="col-sm-2">
                    <input type="number" step="0.01" class="form-control" name="bcxrate" value="<?= set_value('bcxrate', $rate->bcxrate) ?>">
                </div>
            </div>
